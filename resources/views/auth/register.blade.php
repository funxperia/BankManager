                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">账户名</label>
                        ...
                        <div class="form-group{{ $errors->has('pincodes') ? ' has-error' : '' }}">
                            <label for="ID" class="col-md-4 control-label">身份证</label>
